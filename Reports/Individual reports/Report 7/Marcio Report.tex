...
\section{GUI}
Mladen and I are working together on the GUI. We are trying to connect the Kinect sensor to our software and begin the data acquisition. We also added windows for filtering and registration, which allows the user to choose specific methods and parameters for those parts.
