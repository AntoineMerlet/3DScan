...
namespace Core {
pcl::PointCloud<pcl::PointXYZRGB>::Ptr downsample(pcl::PointCloud<pcl::PointXYZRGB>::Ptr);
...
pcl::PointCloud<pcl::PointXYZRGB>::Ptr bilateralFitler(pcl::PointCloud<pcl::PointXYZRGB>::Ptr, const float &, const float &);
pcl::PointCloud<pcl::PointXYZRGB>::Ptr bilateralupsamblerRGB(pcl::PointCloud<pcl::PointXYZRGB>::Ptr, const float &, const float &);
